...
void test_complete_change_assembly() {
    ReviewedSourceTreeInventory baseline{{
            version("modified", ReviewedSourceFileMode::Regular, SHA1_A, 10),
    ...
    ReviewedSourceTreeInventory target{{
            version("modified", ReviewedSourceFileMode::Regular, SHA1_B, 11),
    ...
    ReviewedSourceTreeInventory rename_baseline{{
            version("before", ReviewedSourceFileMode::Regular, SHA1_A, 1)}};
    ReviewedSourceTreeInventory rename_target{{
            version("after", ReviewedSourceFileMode::Regular, SHA1_B, 1)}};
...
void test_malformed_and_inconsistent_streams_fail_closed() {
    ReviewedSourceTreeInventory baseline{{
            version("file", ReviewedSourceFileMode::Regular, SHA1_A, 1)}};
    ReviewedSourceTreeInventory target{{
            version("file", ReviewedSourceFileMode::Regular, SHA1_B, 2)}};
...
void test_resource_limits() {
    ...
    ReviewedSourceTreeInventory aggregate{{
            version("a", ReviewedSourceFileMode::Regular, SHA1_A,
                    REVIEWED_SOURCE_SINGLE_BLOB_LIMIT),
