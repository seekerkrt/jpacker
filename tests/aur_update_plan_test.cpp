...
void test_newer_remote_version_is_update_available() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "sample-package", "1.0-1", "sample-package", "sample-package",
            "2.0-1", AurVersionRelation::NewerThanInstalled));
...
void test_same_remote_version_is_up_to_date() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "sample-package", "1.0-1", "sample-package", "sample-package",
            "1.0-1", AurVersionRelation::SameAsInstalled));
...
void test_older_remote_version_is_up_to_date() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "sample-package", "2.0-1", "sample-package", "sample-package",
            "1.0-1", AurVersionRelation::OlderThanInstalled));
...
void test_missing_aur_metadata_is_non_aur_foreign() {
    AurUpdatePlanEntry entry = classify_aur_update(AurUpdatePlanInput{
            "repository-only-package", "1.0-1", AurUpdateMetadataNotFound{}});
...
void test_unavailable_metadata_remains_distinct() {
    AurUpdatePlanEntry entry = classify_aur_update(AurUpdatePlanInput{
            "unknown-package", "1.0-1", AurUpdateMetadataUnavailable{}});
...
void test_unavailable_version_comparison_remains_distinct() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "sample-package", "opaque-installed", "sample-package", "sample-package",
...
void test_package_name_and_package_base_are_both_preserved() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "split-cli", "1.0-1", "split-cli", "split-suite", "2.0-1",
...
void test_plan_preserves_input_order() {
    const std::vector<AurUpdatePlanInput> inputs = {
            remote_input(
                    "zeta-package", "1", "zeta-package", "zeta-package", "2",
                    AurVersionRelation::NewerThanInstalled),
            {"alpha-package", "1", AurUpdateMetadataNotFound{}},
            remote_input(
                    "middle-package", "1", "middle-package", "middle-package", "1",
...
void test_classifier_uses_relation_without_parsing_versions() {
    AurUpdatePlanEntry entry = classify_aur_update(remote_input(
            "sample-package", "not a pacman version", "sample-package", "sample-package",
            "also:not/a/version", AurVersionRelation::NewerThanInstalled));
...
void test_unknown_version_relation_is_rejected() {
    AurUpdatePlanInput input = remote_input(
            "sample-package", "1.0-1", "sample-package", "sample-package", "2.0-1",
