...
constexpr OperandContract operand_with_trailing_assignments(
    ...
    return OperandContract{{
                                    OperandTermSpec{primary_kind, 1, 1},
                                    OperandTermSpec{
...
constexpr OptionRelationContract source_no_confirm_option_relation()
        noexcept {
    return OptionRelationContract{
            OptionId::NoConfirm,
            OptionRelationRequirement::Optional,
...
constexpr OptionRelationContract sync_select_no_confirm_option_relation()
        noexcept {
    return OptionRelationContract{
            OptionId::NoConfirm,
            OptionRelationRequirement::Optional,
...
constexpr OptionRelationContract sync_select_needed_option_relation()
        noexcept {
    return OptionRelationContract{
            OptionId::Needed,
            OptionRelationRequirement::Optional,
...
constexpr OptionRelationContract pacman_no_confirm_option_relation()
        noexcept {
    return OptionRelationContract{
            OptionId::NoConfirm,
            OptionRelationRequirement::Optional,
...
inline constexpr std::array<SpecialOperationSpec,
        ...
        MOGUET_SPECIAL_OPERATIONS = {{
                ...
                {SpecialOperationId::DelegatedPacmanGrammar, {},
                 no_token_aliases(), GrammarOwnership::DelegatedPacman, true,
                 OperationSemanticScope::PacmanDelegation,
                 DryRunSupport::Unsupported,
                 one_operand_term(
                         OperandKind::DelegatedPacmanArgument, 0,
                         UNBOUNDED_OPERAND_COUNT,
                         OperandOrderingRule::Delegated),
                 TargetPolicy::Delegated,
                 operation_option_relations(
                         delegated_needed_option_relation(),
                         delegated_end_of_options_relation(),
                         pacman_no_confirm_option_relation()),
                 "exit.delegated-pacman", "cli.pacman.open-grammar"},
        }};
