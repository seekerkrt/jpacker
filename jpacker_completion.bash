...
_jpacker() {
    ...
    # 主要コマンドとオプション
    opts="build upgrade clean deps plan fetch add-src del-src edit-src list-src revert -S -Syu -Ss -Si -R -Rs -Rns -Q -Qua -h --help --noedit --nodiff --noconfirm"
    deps_opts="--recursive"
    ...
    case "${prev}" in
        ...
        -S|-Syu)
            ...
            COMPREPLY=( $(compgen -W "--noedit --nodiff --noconfirm" -- ${cur}) )
            return 0
            ;;
    esac
}
