...
| [separated source-build `--rmdeps`](source-build-rmdeps.md) | #269 / #404 / #484 | current source-buildのfail-closed、pacman-only no-op、future causal ownership / interaction boundary |
