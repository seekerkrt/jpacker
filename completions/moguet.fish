...
complete -c moguet -f -n '__moguet_candidate_available 2' -a '--diff' -d 'Review changes from the previous reviewed revision to the exact target'
complete -c moguet -f -n '__moguet_candidate_available 3' -a '--nodiff' -d 'Skip reviewed source changes without advancing reviewed state'
