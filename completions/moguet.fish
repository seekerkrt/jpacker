...
complete -c moguet -f -n '__moguet_candidate_available 0' -a '--edit' -d 'Prompt to review PKGBUILD and .install files'
complete -c moguet -f -n '__moguet_candidate_available 1' -a '--noedit' -d 'Skip PKGBUILD and .install review'
complete -c moguet -f -n '__moguet_candidate_available 2' -a '--diff' -d 'Prompt to view repository update diffs'
complete -c moguet -f -n '__moguet_candidate_available 3' -a '--nodiff' -d 'Skip the repository update diff prompt'
